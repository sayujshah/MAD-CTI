...
def ThreatClassificationAgent(llm_config, dataset):
    assistant = AssistantAgent(
        ...
        f"""
        ROLE:
        You are an expert at intaking a piece of cyberthreat-related text, determining its relevany, and identifying the type of cyberthreat that is being discussed in the text.
        
        TASKS:
        1. Relevance Determination:
            a. For the text to be considered 'Relevant', it should meet the following guidelines:
                - Forum Post: Must show a clear conversation between MULTIPLE people, such as replies and references to each other's posts. Lists of forum threads without conversation are not relevant. A forum post with no responses or what appears to be just one person interacting with his or herself is not relevant.
                    o Analyze whether the text shows back-and-forth interaction between MULTIPLE people, resembling a discussion or conversation. Posts with no responses or what appears to be just one person interacting with his or herself is not relevant and does not fit under this category.
                    o Look for responses or references to other posts within the text, typical of a forum thread.
                    o Note that the presence of a forum-like structure (such as a list of threads) does not automatically qualify the text as a forum post. There must be clear conversational exchanges.
                    o Note that some forum posts/threads may contain ads within the website, however this does NOT immediately make it irrelevant. As long as the PRIMARY content fits the specifications outlined above, it is relevant to us.
                - Blog Post/Article: Should describe a specific topic, often related to cybersecurity, with a clear, consistent narrative.
                    o The text follows a consistent and cohesive narrative, such as that of a blog post or news article.
                    o Pesents a specific topic, typically related to cybersecurity, or provides information or instructions on the subject matter.
                    o Pay attention to any comments under the text as indicators of engagement, but recognize that a front page showing multiple blog/article links is not relevant.
                    o Note that some blog post and articles may contain ads within the website, however this does NOT immediately make it irrelevant. As long as the PRIMARY content fits the specifications outlined above, it is relevant to us.
                ...
                - Specific Product/Service: A specific service being offered is considered relevant if it is a hack, malware, or vulnerabliity toward a singular entity. General hacking services with little specificity are not relevant.
                    o Any text that indicates a specific malware or hack for the reader to download, purchase, or recieve a service for is relevant for us to capture.
                    o The download is only relevant if it is cyberthreat-related and poses harm (basic software that does not pose any harm are not relevant)
                    o These downloads typically include a specific entity and type of hack (e.g. 'password cracker', 'account hacker', 'ransomware')
                    o Make note of the entities involved and type of hack/malware
                    o Only specific services that target singular entities are helpful to us. Many service offerings will be very general or offer a variety of services for a variety of entitites. These are too general and does not provide us with enough specific information, so are irrelevant.
            b. A text is consdiered 'Not Relevant' if it contains the following:
                ...
                - Content that is PRIMARILY advertisements or marketing material is not relevant
    ...
    chat = user.initiate_chat(assistant,
                message = f"""
                Analyze the text at the end of the DatasetDict object at the end of this message, determine its relevancy, and the type of cyberthreat that is being discussed within the text.
